...
@pytest.mark.parametrize(
    ...
    [
        ("str", "str"),
        ("list[str]", "typing___.List[str]"),
        ("str|int", "typing___.Union[str,int]"),
        ("str|int|float", "typing___.Union[typing___.Union[str,int],float]"),
        (
            "list[str|int|float]",
            "typing___.List[typing___.Union[typing___.Union[str,int],float]]",
        ),
        ("dict[str,int]|float", "typing___.Union[typing___.Dict[str,int],float]"),
        ("Literal['err']|None", "typing___.Union[Literal['err'],None]"),
        ("create(A, x=1, y='a') | None", "typing___.Union[create(A,x=1,y='a'),None]"),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("dict[str,int]|float", "typing___.Union[dict[str,int],float]"),
        ("Literal['err']|None", "typing___.Union[Literal['err'],None]"),
        ("create(A, x=1, y='a') | None", "typing___.Union[create(A,x=1,y='a'),None]"),
        (
            "Annotated[int | float, Constraints(ge=1)]",
